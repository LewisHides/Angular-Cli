 ...
 * Initialize App
 *
 * Function to run upon app initialization.
 *
 * @param appConfig
 */
...
@NgModule({
  ...
  imports: [
      ...
      RestangularModule.forRoot((RestangularProvider) => {
          RestangularProvider.setBaseUrl(AppConfig.settings.api.apiUrl);
  ...
  providers: [
      /**
       * Initialize the AppConfig before the App Loads (Constant='AppConfig')
       */
      AppConfig,
      {
